...
\begin{proof}
	...
	This is true because all the students other than those in $C$ are at least $r$ miles away from the students in $C$ according to the definition of $max-dist(C)$.
	...
	The walking distance will be at least $r$ miles.
	Plus the $t$ students in $C$ are also at least $r$ miles away from each other since we pick students greedily.
	We have at least $t+1$ students that are $r$ miles away from each other.
